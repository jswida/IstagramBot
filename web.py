...
class IGBot:
    def __init__(self, username, password):
        ...
        self.driver = webdriver.Chrome('/Users/lilacblue/Downloads/webscraping/chromedriver')
        self.comments = ['Really nice.', 'Love', 'Lovelly!']
...
def Bot(loginIG, passIG):
    ig = IGBot(loginIG, passIG)
    ig.login()
    links = ig.collectLinksOfPhotos('cats', 1)
